...
{
  m_leftBottom = Point( m_leftTop.x() , m_rightBottom.y() );
  m_rightTop = Point(  m_rightBottom.x() , m_leftTop.y()  );

  m_height = abs(m_leftTop.y()) -  abs(m_rightBottom.y());
  m_width  = m_rightBottom.x() + m_leftTop.x() * -1;
